...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height: 448px;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Softs/Alcools</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                $lesAlcools = getAlchool();
                                    foreach($lesAlcools as $uneBiere)
                                    { echo
                                        (   
                                        '<tr>
                                            <td>'.$uneBiere['nom'].'</td>
                                            <td>'.$uneBiere['prix'].' €</td>
                                            <td> <a href="modifA.php?id='.$uneBiere['id'].'"> Mofidier </td>
                                            <td> <a href="supprA.php?id='.$uneBiere['id'].'"> Supprimer </td>
                                         </tr>'
                                ...
                                $lesSofts = getSofts();
                                    ...
                                    { echo
                                        ...
                                        '<tr>
                                            <td>'.$uneBiere['nom'].'</td>
                                            <td>'.$uneBiere['prix'].' €</td>
                                            <td> <a href="modifS.php?id='.$uneBiere['id'].'"> Mofidier </td>
                                            <td> <a href="supprS.php?id='.$uneBiere['id'].'"> Supprimer </td>
                                         </tr>'
