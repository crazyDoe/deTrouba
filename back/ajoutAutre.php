                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="bieres" checked="">Bière
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="alcools" checked="">Alcools
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="softs">Softs
                                                </label>
                                            </div>
                                        
                                </div>
                                        <input type="submit" class="btn btn-outline btn-primary btn-lg btn-block" value="Valider">
                            </form>
