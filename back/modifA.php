...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="min-height: 448px;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Alcools</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="modificationAlcool.php" method="POST">
                               <div class="form-group">
                                    <label>Nom Alcool : </label>
                                    <input type="text" class="form-control" value="<?php echo $laBiere['nom'] ?>" name="nom">
                                    <p class="help-block">Ex : Vodka</p>
                                 </div>
                                <div class="form-group">
                                    <label>Prix : </label>
